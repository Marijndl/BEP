...
if __name__ == "__main__":
    ...
    all_samples_mean,all_samples_std = plot_df(samples_dict_R1,all_samples_mean,all_samples_std)
    all_samples_mean,all_samples_std = plot_df(samples_dict_R2,all_samples_mean,all_samples_std)
    ...
    # Plot formatting:
    plt.axvline(128, linestyle='dotted', color='black')
